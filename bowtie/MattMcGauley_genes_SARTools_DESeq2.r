...
workDir <- "C:/Users/mattmcgauley/Documents/Documents - Matt’s MacBook Pro/Junior Year/Second Semester/BIOL 364/RNASeqProject"      # working directory for the R session

projectName <- "SARTools.DESeq2"                         # name of the project
